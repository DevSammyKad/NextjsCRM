...
import { useStateHistory } from './use-state-history'; // Import your custom hook

// Import or define the countries array
import { countries } from './countries'; // Ensure the path is correct
